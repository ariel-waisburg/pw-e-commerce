...
test("canonical measures follow the latest business definition", () => {
  ...
  assert.equal(normalizeMeasureCode("090 x 190"), null);
  assert.equal(normalizeMeasureCode("160 x 190"), null);
});

test("visible plaza labels keep queen and king for large measures", () => {
  assert.equal(getVisiblePlazaFromMeasure("080x190"), "1 plaza");
  assert.equal(getVisiblePlazaFromMeasure("150x190"), "2 plazas");
