...
export const SIZE_DEFINITIONS = [
  {
    ...
    relatedMeasureCodes: ["100x190", "100x200"],
  },
  {
    measureCode: "100x190",
    name: "1 plaza",
    label: "1 plaza — 100 x 190 cm",
    aliases: ["100x190", "100 x 190", "1 plaza", "1 plaza estandar", "single", "single 100"],
    relatedMeasureCodes: ["080x190", "100x200", "130x190"],
  },
  {
    measureCode: "100x200",
    name: "1 plaza extra largo",
    label: "1 plaza extra largo — 100 x 200 cm",
    aliases: ["100x200", "100 x 200", "1 plaza extra largo", "extra largo"],
    relatedMeasureCodes: ["100x190", "130x190"],
  },
  {
    measureCode: "130x190",
    name: "1 1/2 plazas",
    label: "1 1/2 plazas — 130 x 190 cm",
    aliases: ["130x190", "130 x 190", "1 1/2 plazas", "plaza y media", "una plaza y media"],
    relatedMeasureCodes: ["100x200", "140x190"],
  },
  {
    measureCode: "140x190",
    name: "2 plazas",
    ...
    relatedMeasureCodes: ["150x190", "130x190", "160x200"],
  },
  {
    measureCode: "150x190",
    name: "2 plazas amplio",
    label: "2 plazas amplio — 150 x 190 cm",
    aliases: ["150x190", "150 x 190", "2 plazas amplio", "dos plazas amplio"],
    relatedMeasureCodes: ["140x190", "160x200"],
  },
  {
    measureCode: "160x200",
    name: "Queen",
    ...
    relatedMeasureCodes: ["150x190", "180x200", "160x190"],
    confusionWith: ["160x190"],
  },
  {
    measureCode: "180x200",
    name: "King",
  ...
  },
  {
    measureCode: "200x200",
    name: "Super King",
    label: "Super King — 200 x 200 cm",
    aliases: ["200x200", "200 x 200", "super king", "superking"],
    relatedMeasureCodes: ["180x200", "200x190"],
